/********************************************************
*
* C register defines file for cs344_starter
*
********************************************************/
...
// ===== File: projects/cs344_starter/include/router_op_lut.xml =====
...
// Module tags
#define CORE_BLOCK_ADDR           { 0x0000000; }
#define DEV_ID_BLOCK_ADDR         { 0x0400000; }
#define MDIO_BLOCK_ADDR           { 0x0440000; }
#define DMA_BLOCK_ADDR            { 0x0500000; }
#define MAC_GRP_0_BLOCK_ADDR      { 0x0600000; }
#define MAC_GRP_1_BLOCK_ADDR      { 0x0640000; }
#define MAC_GRP_2_BLOCK_ADDR      { 0x0680000; }
#define MAC_GRP_3_BLOCK_ADDR      { 0x06c0000; }
#define CPU_QUEUE_0_BLOCK_ADDR    { 0x0700000; }
#define CPU_QUEUE_1_BLOCK_ADDR    { 0x0740000; }
#define CPU_QUEUE_2_BLOCK_ADDR    { 0x0780000; }
#define CPU_QUEUE_3_BLOCK_ADDR    { 0x07c0000; }
#define SRAM_BLOCK_ADDR           { 0x1000000; }
#define UDP_BLOCK_ADDR            { 0x2000000; }
#define ROUTER_OP_LUT_BLOCK_ADDR  { 0x2000000; }
#define STRIP_HEADERS_BLOCK_ADDR  { 0x2000100; }
#define IN_ARB_BLOCK_ADDR         { 0x2000200; }
#define OQ_BLOCK_ADDR             { 0x2001000; }
#define DRAM_BLOCK_ADDR           { 0x4000000; }
...
#define ROUTER_OP_LUT_NUM_ARP_PKTS_REG                    0x2000028
#define ROUTER_OP_LUT_NUM_OSPF_PKTS_REG                   0x200002c
#define ROUTER_OP_LUT_MAC_0_HI_REG                        0x2000030
#define ROUTER_OP_LUT_MAC_0_LO_REG                        0x2000034
#define ROUTER_OP_LUT_MAC_1_HI_REG                        0x2000038
#define ROUTER_OP_LUT_MAC_1_LO_REG                        0x200003c
#define ROUTER_OP_LUT_MAC_2_HI_REG                        0x2000040
#define ROUTER_OP_LUT_MAC_2_LO_REG                        0x2000044
#define ROUTER_OP_LUT_MAC_3_HI_REG                        0x2000048
#define ROUTER_OP_LUT_MAC_3_LO_REG                        0x200004c
#define ROUTER_OP_LUT_FAST_REROUTE_ENABLE_REG             0x2000050
#define ROUTER_OP_LUT_LINK_STATUS_REG                     0x2000054
#define ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_IP_REG            0x2000058
#define ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_MASK_REG          0x200005c
#define ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_NEXT_HOP_IP_REG   0x2000060
#define ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_OUTPUT_PORT_REG   0x2000064
#define ROUTER_OP_LUT_ROUTE_TABLE_RD_ADDR_REG             0x2000068
#define ROUTER_OP_LUT_ROUTE_TABLE_WR_ADDR_REG             0x200006c
#define ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_HI_REG          0x2000070
#define ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_LO_REG          0x2000074
#define ROUTER_OP_LUT_ARP_TABLE_ENTRY_NEXT_HOP_IP_REG     0x2000078
#define ROUTER_OP_LUT_ARP_TABLE_RD_ADDR_REG               0x200007c
#define ROUTER_OP_LUT_ARP_TABLE_WR_ADDR_REG               0x2000080
#define ROUTER_OP_LUT_DST_IP_FILTER_TABLE_ENTRY_IP_REG    0x2000084
#define ROUTER_OP_LUT_DST_IP_FILTER_TABLE_RD_ADDR_REG     0x2000088
#define ROUTER_OP_LUT_DST_IP_FILTER_TABLE_WR_ADDR_REG     0x200008c
...
// File: projects/cs344_starter/include/input_arbiter.xml
